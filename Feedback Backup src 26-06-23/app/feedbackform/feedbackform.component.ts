...
export class FeedbackformComponent implements OnInit {
  ...
  send() {
    ...
    var datas = [
      {
        fbStatus: this.segmentValue,
        fbType: this.typeValue,
        fbDetails: this.textarea1,
        userid: userId,
        question: 'question1',
      },
      {
        fbStatus: this.segmentValue2,
        fbType: this.typeValue2,
        fbDetails: this.textarea2,
        userid: userId,
        question: 'question2',
      },
    ];
    const url =
      'https://feedback.apmkingstrack.com/feedback/api/insert/feedback';
  ...
  public language = {
    english: {
      ...
      'Please select your feedback category below.':
        'Please select your feedback category below.',
      'Would You Like Rate the Staff Who Provided Serviced?':
        'Would You Like Rate the Staff Who Provided Service?',
      Sent: 'SUBMIT',
  ...
  ngOnInit() {
    if (localStorage.getItem('language') === 'tan') {
      ...
      this.q1 =
        this.language['english']['Please select your feedback category below.'];
      this.q2 =
