...
admin:FormGroup;
  userDetails: any;
  public url='http://apmkingstrack.com:9080/Feedback/api/add/admin';
  value =false;
  constructor(private formBuilder: FormBuilder,private ajaxService : AjaxService,private router: Router,private commonService:CommonService,  private firebaseX: FirebaseX) { }
  ...
  //  let url='http://apmkingstrack.com:9080/Feedback/api/add/admin';
  //  let url='http://apmkingstrack.com:9080/Feedback/api/update/admin';
  ...
  ngOnInit() {
    ...
    if(localStorage.getItem("details").length >= 20 ){
      this.value=true;
      this.url='http://apmkingstrack.com:9080/Feedback/api/update/admin';
