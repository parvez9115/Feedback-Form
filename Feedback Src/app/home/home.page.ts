...
export class HomePage {
 ...
 public color:any;
  ...
  constructor(  private commonService:CommonService,private http: HttpClient,private router: Router,private ajaxService : AjaxService) {}
//   myFunction(value){
//     console.log("helo");
...
//   }
  ...
  //  var encodeNum = encodeURI(this.number1);
   ...
   var data={"toNumber":this.number1,"otp":this.generatedOtp };
...
reg(){
  this.commonService.presentToast("You are not an registered user, please register");
}
  ...
  submit(){
    ...
    if(JSON.stringify(this.otp) ===  this.generatedOtp){
       let url='http://apmkingstrack.com:9080/Feedback/api/auth/'+this.number1+'';
  ...
  valid(){
    if(JSON.stringify(this.number1).length === 9 || JSON.stringify(this.number1).length === 10){
      this.hide=false;
...
public language = {
  ...
  var data=JSON.stringify({"userid":1,"primaryContact":"9551383012","customerId":"0414","vehicleRegNo":"Tn 14 j 8617",
  "customerName":"JANA","memberId":"91","passportNo":null,"companyName":"APM","position":"Developer",
  "town":"chennai","country":"india","mobileNo2":null,"mobileNo3":null,
  "mobileNo4":null,"mobileNo5":null,"whatsappNo1":null,"whatsappNo2":null});
