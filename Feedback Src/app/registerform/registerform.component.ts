...
export class RegisterformComponent implements OnInit {
  ...
  btnClr7="dark";
  userDetails: any;
   constructor(private commonService:CommonService,private http: HttpClient,private router: Router,private formBuilder: FormBuilder,private ajaxService : AjaxService) {}
   myFunction(value){
    ...
    if(value === "number1"){
     ...
     if(JSON.stringify(this.primaryContact).length === 9 || JSON.stringify(this.primaryContact).length === 10){
                    this.sendBtn1 =false;
  ...
  this.color1="silver";
   ...
   if(JSON.stringify(this.secondaryContact).length === 9 || JSON.stringify(this.secondaryContact).length === 10){
    this.sendBtn2 =false;
...
this.btnClr2 ="dark";
  ...
  if(JSON.stringify(this.mobile3).length === 9 || JSON.stringify(this.mobile3).length === 10){
    this.sendBtn3 =false;
...
this.btnClr3 ="dark";
  ...
  if(JSON.stringify(this.mobile4).length === 9 || JSON.stringify(this.mobile4).length === 10){
    this.sendBtn4 =false;
...
this.btnClr4 ="dark";
  ...
  if(JSON.stringify(this.mobile5).length === 9 || JSON.stringify(this.mobile5).length === 10){
    this.sendBtn5 =false;
...
this.btnClr5 ="dark";
  ...
  if(JSON.stringify(this.mobile6).length === 9 || JSON.stringify(this.mobile6).length === 10){
    this.sendBtn6 =false;
...
this.btnClr6 ="dark";
  ...
  if(JSON.stringify(this.mobile7).length === 9 || JSON.stringify(this.mobile7).length === 10){
    this.sendBtn7 =false;
...
this.btnClr7 ="dark";
   ...
   public data={"mobile1":{"otp":"","number":"","isverify":""},
  ...
  verify(phonenumber,key){
    ...
    if(key == "mobile1"){  
      ...
      if(phonenumber.value == this.data.mobile1.number && JSON.stringify(this.otp1) == this.data.mobile1.otp){
        this.color="green";
      ...
      this.otp2 =this.details.value.otp2;
       if(phonenumber.value == this.data.mobile2.number && JSON.stringify(this.otp2) == this.data.mobile2.otp){
        this.color1="green";
      ...
      if(phonenumber.value == this.data.mobile3.number && JSON.stringify(this.otp3) == this.data.mobile3.otp){
       this.color2="green";
      ...
      if(phonenumber.value == this.data.mobile4.number && JSON.stringify(this.otp4) == this.data.mobile4.otp){
       this.color3="green";
      ...
      if(phonenumber.value == this.data.mobile5.number && JSON.stringify(this.otp5) == this.data.mobile5.otp){
       this.color4="green";
      ...
      if(phonenumber.value == this.data.mobile6.number && JSON.stringify(this.otp6) == this.data.mobile6.otp){
       this.color5="green";
      ...
      if(phonenumber.value == this.data.mobile7.number && JSON.stringify(this.otp7) == this.data.mobile7.otp){
       this.color6="green";
   ...
   getOtp(phonenumber,key){
    ...
    //  }) 
     var url1 ="http://apmkingstrack.com:9080/Feedback/api/otp";
   ...
   submit(){
    ...
    var datas = {
       ...
       if(JSON.stringify(this.otp1)   ==  this.data.mobile1.otp ){
         let url='http://apmkingstrack.com:9080/Feedback/api/add/user';
     ...
     public language={
      ...
      "feedbackform":"FeedBack Form",
       ...
       tanzania:{"feedbackform":"FeedBack Form",
       "Let's get in touch":"Let's get in touch",
       "name":"Name",
       "send otp":"SEND OTP",
       "enter otp":"Enter OTP",
    ...
    //     return englishText[text];
     ...
     this.vehicleregistrationNo =this.language["tanzania"]["Vehicle Registration No"];
