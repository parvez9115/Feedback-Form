...
export class AdminsettingComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,private router: Router,private ajaxService : AjaxService,private commonService:CommonService) { }
...
if(valid != true) {
   this.isDisabled=true;
    ...
    var url1='http://apmkingstrack.com:9080/Feedback/api/appSetting';
    // var details=[];
    var dat='';
    for(var i=0;this.sellingPoints.value.length;i++){
      if ( this.sellingPoints.value.length == [i]) { 
...
changeBtn(){
  ...
  ngOnInit() {
    ...
    const url='http://apmkingstrack.com:9080/Feedback/api/appSetting/branch';
